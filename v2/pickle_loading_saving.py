...
def save_data_pickle(data, type, k=None):
    ...
    if k is None:
        f = open("pickles/" + type + "/" + type + "_data.pickle", "wb")
        pickle.dump(data, f)
        f.close()
    else:
        i = 0
        while i + k <= len(data):
            f = open("pickles/" + type + "/" + type + "_data_" + str(i) + ".pickle", "wb")
...
def load_data_pickle(type, k=None):
    ...
    if k is None:
        f = open("pickles/" + type + "/" + type + "_data.pickle", "rb")
        data = pickle.load(f)
        f.close()
    else:
        i = 0
        ...
        try:
            while True:
                f = open("pickles/" + type + "/" + type + "_data_" + str(i) + ".pickle", "rb")
                data += pickle.load(f)
                f.close()
                i += k
...
def save_matrix_X(data_X, type, k=None):
    ...
    if k is None:
        f = open("pickles/" + type + "/" + type + "_matrix_X.pickle", "wb")
        pickle.dump(data_X, f)
        f.close()
    else:
        i = 0
        while i + k <= data_X.shape[0]:
            f = open("pickles/" + type + "/" + type + "_matrix_X_" + str(i) + ".pickle", "wb")
...
def load_matrix_X(type, k=None):
    ...
    if k is None:
        f = open("pickles/" + type + "/" + type + "_matrix_X.pickle", "rb")
        ...
        try:
            while True:
                f = open("pickles/" + type + "/" + type + "_matrix_X_" + str(i) + ".pickle", "rb")
                if data_X is None:
                    data_X = pickle.load(f)
                else:
...
def save_matrix_Y(data_Y, type, window, margin):
    ...
    f = open("pickles/" + type + "/" + type + "_matrix_Y_" + str(window) + "_" + str(margin) + ".pickle", "wb")
...
def load_matrix_Y(type, window, margin):
    ...
    try:
        f = open("pickles/" + type + "/" + type + "_matrix_Y_" + str(window) + "_" + str(margin) + ".pickle", "rb")
...
def save_matrix_IDs(data_IDs, type):
    ...
    f = open("pickles/" + type + "/" + type + "_matrix_ID.pickle", "wb")
...
def load_matrix_IDs(type):
    ...
    f = open("pickles/" + type + "/" + type + "_matrix_ID.pickle", "rb")
...
def save_labels(labels, type):
    ...
    f = open("pickles/" + type + "/" + type + "_labels.pickle", "wb")
...
def load_labels(type):
    ...
    f = open("pickles/" + type + "/" + type + "_labels.pickle", "rb")
