...
def parallelized_matrix_creation(window_range, margin_range, back_window_short_range, back_window_medium_range, back_window_long_range, back_window_range, type, ids, raw_data, data_X, train_f, get_dates_f, feature_selector, model, client, get_Y_relative_f, get_Y_f, date_key, currency_key, is_conversation, articles, conversations, tweets, n_features):
