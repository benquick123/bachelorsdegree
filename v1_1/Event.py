...
class Event:
    ...
    def __str__(self):
        ...
        string += "start: " + datetime.utcfromtimestamp(self.first_price_info["_id"]).strftime('%Y-%m-%d %H:%M:%S') + ", relevant_end: " + datetime.utcfromtimestamp(self.last_relevant_price_info["_id"]).strftime('%Y-%m-%d %H:%M:%S') + "\n"
    ...
    def get_data(self):
        ...
        d["last_relevant_price_info"] = self.last_relevant_price_info
        ...
        d["time_x"] = (self.time_x1, self.time_x2, self.time_x3)
        return d
    ...
    def set_data(self, data):
        ...
        self.last_relevant_price_info = data["last_relevant_price_info"]
        ...
        self.time_x1, self.time_x2, self.time_x3 = data["time_x"]
